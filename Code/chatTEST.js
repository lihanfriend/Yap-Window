        ...
        `;
            ...
            async _mkdir(dir, needPwd, isSudo) {
                ...
                await update(this._nodeRef(parent), {
                    [key]: {
                        [this._keyName("DONOTDELETE")]: "NODELETE"
                    },
                });
...
`;
                        ...
                        await update(tiggy, {
                            User: BOT_USERS.TIGGYBOT,
                            Message: "Maybe it wasn't the best idea to throw Tiggy onto the ceiling fan...",
                            Date: Date.now(),
                        });
                    } else {
                        const now = new Date();
            ...
            async function createChannelHandler() {
                ...
                const channelData = {
                    ...
                    Members: type === "Private" ?
                        members.join(",") : isModifying && originalMembers && originalMembers !== "None" ?
                        originalMembers : email.replace(/\./g, "*"),
                    Type: type,
